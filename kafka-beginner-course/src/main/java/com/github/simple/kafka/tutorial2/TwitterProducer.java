...
public class TwitterProducer {
    ...
    public TwitterProducer() {
        ...
        try {
            ...
            FileReader resources= new FileReader("./src/main/resources" + twitterApiConfigPath);
            properties.load(resources);

            this.consumerKey = properties.getProperty("consumerKey");
            this.consumerSecret = properties.getProperty("consumerSecret");
            this.token = properties.getProperty("token");
            this.tokenSecret = properties.getProperty("tokenSecret");
    ...
    public void run() {
        ...
        while (!client.isDone()) {
            ...
            if(msg != null) {
                logger.info(msg);
                ProducerRecord<String, String> twitterTweets = new ProducerRecord<String, String>("twitter_tweets", msg);
                kafkaProducer.send(twitterTweets, new Callback() {
    ...
    public Client createTwitterClient(BlockingQueue<String> msgQueue) {
        ...
        List<String> terms = Lists.newArrayList("문재인");
        hosebirdEndpoint.trackTerms(terms);

        // These secrets should be read from a config file
        Authentication hosebirdAuth = new OAuth1(this.consumerKey, this.consumerSecret, this.token, this.tokenSecret);
